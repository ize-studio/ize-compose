...
For `v1.4.0`, the browser setup page can save repository settings for the top-level `Sync` path.
...
`/ize_compose/ize_compose_1-4-0.html` is now the single browser page for both WiFi mode and WebServer mode. It has two tabs:
